...
sender_pass = "....." # Get it from myaccount.google.com & search "App Passwords", make sure to have 2FA active on that account

receiver_email = ["..."] # needs to be a list, you can add more than one recevier.

Subject = "SATChecker Results"
...
def main():
    ...
    while(True):
        ...
        if(len(items) > 0):
            ...
            bumped += "This is an automated Email regarding SAT Checker\n"
